 ...
 */
public class HtlcDepositFundsDemo {
    ...
    public static void use() throws Exception {
        ...
        byte[] passwordHashBytes = Util.hexToByteArray("0x0363f64ef0ff5d7160bcdf6cb86af91bb9e243f4aeeaaf78251ff48e3d690962");
        ...
        TransactionReceipt transactionReceipt = bHtlcContract.depositFunds(aAddress, passwordHashBytes, BigInteger.valueOf(600L),
                tokenContract,new BigInteger("10")).send();
